...
window.CustomComponents = new _custom__WEBPACK_IMPORTED_MODULE_0__["Custom"]();
window.showMessage = _custom__WEBPACK_IMPORTED_MODULE_0__["showMessage"];
/**
 * Filter panel
 */
...
/*!********************************!*\
  !*** ./resources/js/custom.js ***!
  \********************************/
/*! exports provided: Custom, showMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Custom = /*#__PURE__*/_createClass(function Custom() {
  var _this = this;
  ...
  _defineProperty(this, "init", function () {
    ...
    _this.initDate(); //bulma tags input
  ...
  _defineProperty(this, "initModalActions", function () {
    //active
    $('.open-modal').click(function () {
      var $parent = $(this).parents('div.modal-container');
  ...
  _defineProperty(this, "initDate", function () {
    var dateOptions = {
      type: 'date',
    ...
    var datePickers = bulmaCalendar.attach('[type="date"]', dateOptions);
    var timeOptions = {
      type: 'time',
      timeFormat: 'HH:mm',
      closeOnSelect: false,
    ...
    var timePickers = bulmaCalendar.attach('[type="time"]', timeOptions);
    var dtOptions = {
      type: 'datetime',
      dateFormat: 'yyyy-MM-dd',
      timeFormat: 'HH:mm',
    ...
    var dtPickers = bulmaCalendar.attach('[type="datetime"]', dtOptions); // Loop on each calendar initialized
  ...
  _defineProperty(this, "showAjaxErrors", function (response) {
    var errors;
  ...
  _defineProperty(this, "preventSubmitOnEnter", function ($form) {
...
/***/ 0:
/*!*******************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/sass/app.scss ./resources/sass/plugins.scss ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
